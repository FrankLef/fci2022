...
Section 6.3 claims that $T=600$ and $P(T=1 \mid H) \in [0.041, 0.0468]$ but 
the results obtained from running `simdr` as shown in the book are different. 
...
> both the numbers of individuals with $Y=0$ and $Y=1$ need to be larger 
than ten times the number of parameters.
