...
Note that the formula used by B. Brumback is using the standard deviation of the population $p(1-p)$ which is not entirely the right way since the standard error of the mean is defined using the *standard deviation of the sample*.
